<template>
  ...
  <div class="container-fluid">
    <router-link :to="{name:'home'}" class="navbar-brand ms-4"><img src="../assets/logo.png" alt="logo"> E-Cart</router-link>
    <button class="navbar-toggler" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasDarkNavbar" aria-controls="offcanvasDarkNavbar" aria-label="Toggle navigation">
      <span class="navbar-toggler-icon"></span>
    </button>
    <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">      
        <div class="offcanvas-header">
        <h5 class="offcanvas-title" id="offcanvasNavbarLabel">ABRIO Cart</h5>
        ...
        <li class="nav-item dropdown me-4">
          ...
          <ul class="dropdown-menu ">
            ...
            <li><a class="dropdown-item" href="#">User orders</a></li>
